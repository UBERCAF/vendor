...
DEBUG = False
default_manifest = ".repo/manifests/uber_default.xml"
custom_local_manifest = ".repo/local_manifests/uber_manifest.xml"
custom_default_revision = "8.0"
custom_dependencies = "uber.dependencies"
org_manifest = "uberdevices"  # leave empty if org is provided in manifest
org_display = "UBER Devices"  # needed for displaying
